...
export const metadata: Metadata = {
  title: "Pricing — Qudurat Premium",
  description: "Unlock unlimited Qudurat practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=qudurat&cadence=annual`;
