// Auto-generated shim — re-exports from @/lib/qudurat/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _qudurat_Config } from "@/lib/qudurat/config";
import { EXAM_CONFIG as _raw } from "@/lib/qudurat/config";
